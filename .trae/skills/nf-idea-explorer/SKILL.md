...
0. 从用户输入中提取题材, 如果用户没有提供题材, 则随机提供多个题材。
1. 执行trend流程分析趋势、热门元素、读者偏好、竞争分析、创新空间
2. 执行concept流程生成核心创意概念、人物设定、场景设定、冲突设定、解决设定、结尾设定
3. 执行twist流程为每个概念添加独特创新点、创新元素、创新机制
4. 输出5-10个完整创意方案, 每个方案包含标题、题材、篇幅、摘要等
...
| 文档 | 路径 |
| ---- | ---- |
| 创意方案报告 | `novels/<项目名>/novel.md` |
| 市场分析报告 | `novels/<项目名>/market-analysis.md` |
