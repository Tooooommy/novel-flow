...
├────────────────────────────────────────────────────────────────────────┤
│                                                                         │
│  Phase 1: 数据采集 (标准数据源清单)                                       │
│  ├──→ 平台榜单数据                                                       │
│  │      - 起点中文网: 月票榜、推荐票榜、打赏榜、收藏榜                      │
│  │      - 纵横中文网: 推荐票榜、打赏榜                                    │
│  │      - 晋江文学城: 积分榜、营养液榜                                   │
│  │      - 番茄小说: 飙升榜、完读率榜                                     │
│  │                                                                         │
...
│  │                                                                         │
│  ├──→ 升级体系维度                                                       │
│  │      - 现有体系类型: 系统流/功法流/血脉流/天赋流/交易流                  │
│  │      - 读者反馈: 吐槽点/期待点                                         │
│  │      - 创新空间评估: 红海/蓝海                                         │
│  │                                                                         │
│  ├──→ 世界观维度                                                         │
│  │      - 背景类型: 都市/异界/星际/洪荒/现代修真                          │
│  │      - 规则创新度: 独特法则/日常化/反差化                               │
│  │                                                                         │
│  ├──→ 人物设定维度                                                       │
│  │      - 主角类型分布: 废物流/天才流/腹流氓/阳光流                        │
│  │      - 女主类型: 圣女/魔女/青梅/病娇/御姐                              │
│  │      - 配角的创新空间                                                 │
│  │                                                                         │
│  ├──→ 金手指维度                                                         │
│  │      - 类型: 抽奖/任务/击杀/签到/传承/记忆                              │
│  │      - 强度: 弱开局/中等/开挂级                                        │
│  │      - 读者接受度: 高/中/低                                           │
│  │                                                                         │
│  ├──→ 剧情套路维度                                                       │
...
```json
{
  ...
  "data_sources": ["起点月票榜TOP50", "起点推荐票榜TOP100", "读者评论分析"],
  "hot_elements": {
    "upgrade_systems": [
      {
        "element": "系统流",
        "heat_level": 95,
        "trend": "上升",
        "reader_feedback": "又爱又恨"
      }
    ],
    "female_leads": [
      { "element": "多女主", "heat_level": 88, "trend": "稳定" }
    ],
    "golden_fingers": [
      { "element": "任务奖励型", "heat_level": 90, "trend": "稳定" }
    ]
  },
  "reader_expectations": {
    "pace": "快节奏、打脸干脆",
  ...
  "market_opportunity": {
    "blue_ocean": ["反套路系统", "新职业设定", "多元素融合"],
    "differentiation_points": ["世界观创新", "人设反差", "节奏把控"]
  },
  "risk_assessment": {
    "oversaturated": ["传统系统流", "退婚流"],
    "declining": ["纯凡人流"]
  }
}
```
...
│  M1: 元素拆解法                                                         │
│  ├── 操作: 将热门元素拆解为更小单元                                      │
│  │        例: "系统流" → 系统类型(任务/抽奖/击杀)+ 奖励类型 + 惩罚机制    │
│  │                                                                         │
│  └── 组合: 跨类别重新组合                                               │
│           例: 系统(任务型) + 惩罚机制(随机负面) + 凡人流(无等级)           │
│           = "惩罚系统流"                                                 │
│                                                                         │
│  M2: 反向思维法                                                         │
│  ├── 操作: 将热门元素反转                                               │
...
│  M5: 缺失补全法                                                         │
│  ├── 操作: 找到某题材中缺失的元素                                        │
│  │        例: 系统流常见缺失: 系统会消失/系统会进化/系统有意识             │
│  │        例: 退婚流常见缺失: 女方视角/不退婚但有问题                      │
│  │                                                                         │
│  └── 创新: 补全缺失创造差异化                                           │
│                                                                         │
└────────────────────────────────────────────────────────────────────────┘
