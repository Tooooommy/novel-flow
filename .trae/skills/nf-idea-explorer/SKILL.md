...
| 步骤   | 操作         | 要点                                                             |
| ------ | ------------ | ---------------------------------------------------------------- |
| Step 1 | 元素提取     | 从趋势中提取3-5个热门元素，如["系统流", "凡人流", "宗门战争"]    |
| Step 2 | 差异化组合   | 将元素进行非传统组合，如"最弱系统"=系统流+凡人流                 |
| Step 3 | 核心设定生成 | 主角(身份/处境/天赋)、世界(背景/规则/势力)、目标(短期/中期/长期) |
| Step 4 | 剧情结构     | 开头:困境/觉醒、中段:成长/冲突、高潮:逆转/爆发                   |
