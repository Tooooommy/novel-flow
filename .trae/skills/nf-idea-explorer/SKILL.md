...
```
/nf-idea-explorer [--count <数量>] [--genre <题材>]
```
...
1. 执行trend节点分析趋势、热门元素、读者偏好
2. 执行concept节点生成核心创意概念
3. 执行twist节点为每个概念添加独特创新点
4. 输出成完整创意方案
...
4. 输出： 市场趋势报告, 包含热门元素、读者期待、市场机会、风险评估
...
6. 输出：生成的核心概念, 包含核心编号、标题、标签列表、人物设定、世界观、剧情主线、金手指、核心卖点、文风类型、分析维度
...
1. 核心编号： 用于唯一标识每个概念的数字或字母组合
2. 标题： 概念的核心爽点、读者期待、市场机会等
3. 标签列表： 与概念相关的热门元素、读者期待、市场机会等
4. 人物设定： 主角(身份/处境/天赋)、世界(背景/规则/势力)、目标(短期/中期/长期)
5. 剧情主线： 开头:困境/觉醒、中段:成长/冲突、高潮:逆转/爆发
6. 金手指： 类型：抽奖/任务/击杀/签到/传承/记忆
7. 核心卖点： 与概念相关的创新点、新元素融合、反套路设计等
8. 文风类型： 轻松/严肃/幽默/虐心/烧脑
9. 分析维度： 升级体系（系统/功法/血脉）、女主类型（圣女/魔女/青梅）、战斗场景（宗门战争/天才流/凡人流）、金手指（抽奖/任务/击杀）
...
| ---- | ------------------------------------- |
| 编号 | 唯一标识，如 S-001                    |
| 标题 | 核心卖点+题材，如"废物逆袭，校花倒贴" |
| 标签 | 题材标签\|元素标签\|风格标签          |
| 亮点 | 核心创新点，用"+"分隔                 |
| 简介 | 一段式简介，包含身份+困境+金手指+看点 |
...
ideas:
  - id: S-001
    ...
    protagonist:
      identity: 废物上门女婿
      hidden_identity: 修仙天赋觉醒者
      situation: 被家族抛弃、被妻子看不起
      golden_finger: 修仙系统
    plot:
      opening: 废物女婿意外觉醒修仙天赋
      development: 修为快速提升，引来各方势力关注
      climax: 揭露真实身份，岳母震惊
    summary: 废物上门女婿意外觉醒修仙天赋，在都市掀起修仙风暴
    word_count: 200-300万
    target_audience: 20-35岁男性

  - id: S-002
    title: 异世穿越：成为史上最弱召唤师
    genre: 奇幻
    tags:
      - 奇幻
      - 穿越
    ...
    protagonist:
      identity: 召唤师
      hidden_identity: 隐藏天赋
      situation: 召唤兽是最弱史莱姆
      golden_finger: 史莱姆进化系统
    plot:
      opening: 穿越异世成为召唤师
      development: 发现史莱姆有进化潜力
      climax: 史莱姆进化成神兽
    summary: 穿越异世成为召唤师，但召唤兽是最弱史莱姆
    word_count: 150-250万
