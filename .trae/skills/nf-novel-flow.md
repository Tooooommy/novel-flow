...
┌─────────────────────▼───────────────────────────────────┐
│                  nf-novel-flow (主控)                    │
│  idea → init → outline → write → review → optimize → publish │
└─────────────────────┬───────────────────────────────────┘
                      │
     ┌─────────────────┼─────────────────┐
     │                 │                 │
...
| 分类     | 技能                    | 用途               |
| -------- | ----------------------- | ------------------ |
| 创意研发 | nf-idea-explorer        | 创意探索、市场分析 |
| 架构设计 | nf-story-architect      | 世界观、人物、大纲 |
| 内容生产 | nf-content-generator    | 章节正文生成       |
| 风格学习 | nf-style-learner        | 风格模仿、写作提升 |
